...
const int LID_START_POSITION = 130;
const int LID_END_POSITION = 50;
const int SWITCH_START_POSITION = 45;
const int SWITCH_END_POSITION = 130;
const int SWITCH_HALF_POSITION = 75;
